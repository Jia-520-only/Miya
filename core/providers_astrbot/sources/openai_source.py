...
class ProviderOpenAIOfficial(Provider):
    ...
    def _apply_provider_specific_extra_body_overrides(self, extra_body: dict[str, Any]) -> None:
    ...
    def _finally_convert_payload(self, payloads: dict) -> None:
        ...
        is_deepseek_v4_reasoning = model in deepseek_reasoning_models or "api.deepseek.com" in self.client.base_url.host
