...
class AutonomousEngine:
        ...
        while self.is_running:
            try:
                ...
                if not problems:
                    ...
                    # 优先处理高风险问题
                    high_priority_problems = [p for p in problems if p.severity.value in ["critical", "high"]]
    ...
    def generate_improvement_report(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "decision_types": {
                dt.value: sum(1 for d in self.decisions if d.decision_type == dt) for dt in DecisionType
            },
            "risk_levels": {rl.name: sum(1 for d in self.decisions if d.risk_level == rl) for rl in RiskLevel},
