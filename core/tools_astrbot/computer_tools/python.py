...
class PythonTool(FunctionTool):
    ...
    async def call(self, context: ContextWrapper[AstrAgentContext], code: str, silent: bool = False) -> ToolExecResult:
...
class LocalPythonTool(FunctionTool):
    ...
    description: str = f"Execute codes in a Python environment. Current OS: {_OS_NAME}. Use system-compatible commands."
