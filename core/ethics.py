...
class Ethics:
    ...
    def __init__(self):
        # 硬性禁止事项
        self.forbidden_actions = {"harm_user", "illegal_content", "discrimination", "privacy_breach", "malicious_code"}

        # 需要权限的操作
        self.permission_required = {"system_modification", "data_export", "external_api_call"}
    ...
    def get_ethics_report(self) -> Dict:
        ...
        return {
            ...
            "permission_levels": {level: len(permissions) for level, permissions in self.permission_levels.items()},
        }
