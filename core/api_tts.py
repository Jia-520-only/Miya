...
class APITTSEngine(TTSEngine):
    ...
    async def _call_openai_api(self, text: str, output_path: str, voice: str, speed: float) -> Optional[str]:
        ...
        try:
            ...
            response = await loop.run_in_executor(
                None,
                lambda: requests.post(self.api_url, headers=headers, json=data, timeout=NetworkTimeout.API_REQUEST_TIMEOUT)
            )
    ...
    async def _call_azure_api(self, text: str, output_path: str, voice: str, speed: float) -> Optional[str]:
        ...
        try:
            ...
            response = await loop.run_in_executor(
                None,
                lambda: requests.post(self.api_url, headers=headers, data=ssml, timeout=NetworkTimeout.API_REQUEST_TIMEOUT)
            )
    ...
    async def _call_baidu_api(self, text: str, output_path: str, voice: str, speed: float) -> Optional[str]:
        ...
        try:
            ...
            response = await loop.run_in_executor(
                None,
                lambda: requests.post(self.api_url, headers=headers, params=params, timeout=NetworkTimeout.API_REQUEST_TIMEOUT)
            )
