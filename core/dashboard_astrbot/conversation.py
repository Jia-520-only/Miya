        ...
        try:
            ...
            if "conversations" in data:
                ...
                if not conversations:
                    return Response().error("批量删除时conversations参数不能为空").__dict__
    ...
    async def update_history(self):
        ...
        try:
            ...
            try:
                ...
                return Response().error("history 必须是有效的 JSON 字符串或数组").__dict__
        ...
        try:
            ...
            for conv_info in conversations_to_export:
                ...
                try:
                    ...
                    failed_items.append(f"user_id:{user_id}, cid:{cid} - {e!s}")
                    logger.error(f"导出对话失败: user_id={user_id}, cid={cid}, error={e!s}")
