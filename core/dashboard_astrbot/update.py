...
class UpdateRoute(Route):
    ...
    async def check_update(self):
        ...
        try:
            ...
            if type_ == "dashboard":
                return Response().ok({"has_new_version": dv != f"v{VERSION}", "current_version": dv}).__dict__
    ...
    async def update_project(self):
        ...
        try:
            ...
            if reboot:
                ...
                ret = Response().ok(None, "更新成功，AstrBot 将在 2 秒内全量重启以应用新的代码。").__dict__
                return ret, 200, CLEAR_SITE_DATA_HEADERS
            ret = Response().ok(None, "更新成功，AstrBot 将在下次启动时应用新的代码。").__dict__
            return ret, 200, CLEAR_SITE_DATA_HEADERS
        except Exception as e:
