...
class WeixinOfficialAccountServer:
    def __init__(
        ...
        self.callback: Callable[[BaseMessage], Coroutine[Any, Any, str | None]] | None = None
...
@register_platform_adapter("weixin_official_account", "微信公众平台 适配器", support_streaming_message=False)
