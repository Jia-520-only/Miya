    ...
    def config(self) -> Dict[str, Any]:
        return {
            ...
            "parameters": {
                "type": "object",
                "properties": {
                    "memory_id": {"type": "string", "description": "记忆ID（可以使用 memory_list 查询）"},
                    "content": {"type": "string", "description": "新的记忆内容"},
                    "priority": {"type": "number", "description": "新的优先级 (0-1)", "minimum": 0, "maximum": 1},
                    "tags": {"type": "array", "description": "新的标签，会替换原有标签", "items": {"type": "string"}},
                    "memory_type": {
                        "type": "string",
            ...
            if cognitive_memory:
                try:
                    success = await cognitive_memory.update_memo(
                        memo_id=memory_id, content=content, priority=priority, tags=tags
                    )
