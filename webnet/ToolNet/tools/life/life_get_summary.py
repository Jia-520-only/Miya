...
class LifeGetSummary(BaseTool):
    ...
    def config(self) -> Dict[str, Any]:
        return {
            ...
            "parameters": {
                "type": "object",
                "properties": {
                    "level": {"type": "string", "description": "总结层级（weekly/monthly/quarterly/yearly）"},
                    "period": {"type": "string", "description": "周期（如：2025-W09, 2025-01, 2025-Q1, 2025）"},
                },
    ...
    async def execute(self, args: Dict[str, Any], context: ToolContext) -> str:
        ...
        result = await life_net.handle_tool_call(
            "life_get_summary", {"level": level, "period": period}, {"lifenet": life_net}
        )
