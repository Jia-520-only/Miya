...
class ChartGenerator(BaseTool):
            ...
            "function": {
                ...
                "parameters": {
                    ...
                    "properties": {
                        ...
                        "style": {"type": "string", "description": "图表样式（可选）"},
                    },
                    "required": ["chart_type"],
                },
            },
    ...
    def create_line_chart(
        ...
        for i, y_col in enumerate(y_columns):
            if y_col in data.columns:
                ...
                ax.plot(data[x_column], data[y_col], marker="o", linewidth=2, markersize=6, color=color, label=y_col)
    ...
    def create_heatmap(
        self, data: pd.DataFrame, title: str = "热力图", cmap: str = "YlGnBu", output_path: str = None
    ) -> Optional[str]:
        """创建热力图"""
    ...
    def create_scatter_plot(
        ...
        if color_column and color_column in data.columns:
            ...
            ax.scatter(
                data[x_column], data[y_column], color="#2dd4bf", alpha=0.7, s=100, edgecolors="white", linewidths=1.5
            )
    ...
    def _save_chart(self, fig, output_path: str = None, default_name: str = "chart") -> str:
        """保存图表"""
    ...
    def create_dashboard(self, charts: List[Dict[str, Any]], title: str = "数据看板", output_path: str = None) -> str:
        """
        创建多图表看板
...
def generate_chart(
    chart_type: str, data: pd.DataFrame, config: Dict[str, Any], output_path: str = None
) -> Dict[str, Any]:
    """
    生成图表的统一接口
    ...
    try:
        ...
        return {"success": True, "chart_path": result_path, "chart_type": chart_type}
    except Exception as e:
