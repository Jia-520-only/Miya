...
class UserMapper:
    ...
    def ensure_user_exists(
        self, platform: str, original_id: str, username: Optional[str] = None, permission_groups: Optional[list] = None
    ) -> str:
        """
        确保用户存在，如果不存在则创建
    ...
    def get_all_platform_users(self, platform: str) -> list:
        ...
        return [user for user in users_data.get("users", []) if user.get("platform") == platform]
