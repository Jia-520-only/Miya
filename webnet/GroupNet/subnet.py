...
class GroupNet:
    ...
    def _init_tools(self):
        """导入群管理工具"""
        from tools.tools.get_member_list import GetMemberList
        from tools.tools.get_member_info import GetMemberInfo
        from tools.tools.find_member import FindMember
        from tools.tools.filter_members import FilterMembers
        from tools.tools.rank_members import RankMembers
